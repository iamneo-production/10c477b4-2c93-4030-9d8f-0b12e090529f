    ...
    <MDBContainer fluid className='p-4'>
      ...
      <MDBRow>
        ...
        <MDBCol md='6' className='text-center text-md-start d-flex flex-column justify-content-center'>
          ...
          A Master of Cybersecurity is a postgraduate degree program that focuses on advanced knowledge and skills in protecting computer systems, networks, and data from cyber threats and attacks. Students learn about risk assessment, encryption, incident response, and security management to address evolving cybersecurity challenges.
          </p>
