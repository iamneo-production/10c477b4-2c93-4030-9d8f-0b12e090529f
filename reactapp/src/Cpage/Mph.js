    ...
    <MDBContainer fluid className='p-4'>
      ...
      <MDBRow>
        ...
        <MDBCol md='6' className='text-center text-md-start d-flex flex-column justify-content-center'>
          ...
          A Master of Physics is a postgraduate degree program that provides advanced education and training in the field of physics. Students delve into theoretical and experimental aspects of physics, studying topics such as quantum mechanics, electromagnetism, particle physics, and astrophysics to gain a deep understanding of the fundamental laws that govern the universe.
          </p>
