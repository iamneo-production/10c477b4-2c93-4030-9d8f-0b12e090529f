    ...
    <MDBContainer fluid className='p-4'>
      ...
      <MDBRow>
        ...
        <MDBCol md='6' className='text-center text-md-start d-flex flex-column justify-content-center'>
          ...
          A Master of Business Administration (MBA) is a postgraduate degree program that provides comprehensive training in business management, leadership, and strategic decision-making to prepare individuals for senior-level positions in various industries.          </p>
